...
const STORY_PAGES = [
    {
        speaker: "Narrador",
        text: "Na aurora, os sinos do castelo ecoaram como aviso de tragédia: a princesa havia sido sequestrada e levada para a Floresta da Neblina."
    },
    {
        speaker: "Rei Aldric",
        text: "Entre todos os combatentes do reino, apenas um foi escolhido a dedo pelo Rei: um soldado de elite capaz de sobreviver onde exércitos inteiros desaparecem."
    },
    {
        speaker: "Missão",
        text: "Cruze a floresta letal, derrote feras e bandidos, encontre a princesa e traga-a de volta antes que a esperança do reino se apague."
    },
    {
        speaker: "Presságio",
        text: "Mas a névoa esconde mais do que monstros. Rumores falam de lâminas estrangeiras, soldados disfarçados e um império rival pronto para transformar o resgate no estopim de uma guerra."
    },
    {
        speaker: "Hidden War",
        text: "A primeira trilha começa agora. Cada passo na Fase 1 pode revelar se esta é apenas uma missão de resgate... ou o início de uma guerra oculta."
    }
];
